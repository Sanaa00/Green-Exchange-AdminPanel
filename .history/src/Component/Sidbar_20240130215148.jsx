import { NavLink, Navigate, Outlet, useHistory } from 'react-router-dom';
...
function Sidbar() {
  ...
  // });
  // console.log('logout', JSON.parse(localStorage.getItem('admin')) === null);
  // useEffect(() => {
  //   if (
  ...
  const logout = useCallback(() => {
    // Clear the 'admin' data in localStorage
    localStorage.setItem('admin', null);
  ...
  useEffect(() => {
    // Check if 'admin' data is null in localStorage
