...
function Products() {
  ...
  const blockHandler = (itemId) => {
    block({ productid: itemId, id });
  };
  const deleteHandler = (itemId) => {
    addDonate({ productid: itemId, id });
  };
  if (isError) {
    return (
                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  <div className="flex items-end justify-center">
                    ...
                    <button onClick={() => deleteHandler(item?._id)}>
                      <IoCheckmarkDoneCircleOutline className="w-6 h-6 mr-2" />
                    </button>
                  </div>
                </div>
